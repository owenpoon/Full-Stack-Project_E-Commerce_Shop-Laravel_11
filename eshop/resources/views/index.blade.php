...
<main style="padding-top: 0">
  ...
  <section class="swiper-container js-swiper-slider swiper-number-pagination slideshow" data-settings='{
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 translate-middle">
              <h6 class="text_dash text-uppercase fw-medium animate animate_fade animate_btt animate_delay-3">
                New Arrivals</h6>
      ...
      <div class="container">
        <div
          class="slideshow-pagination slideshow-number-pagination d-flex align-items-center position-absolute bottom-0">
        </div>
      </div>
